...
class DictionaryTestSuite {
    ...
    public void findEnglishWords() {
        ...
        dictionary.addWord("pokoj", new EnglishWord(PartOfSpeech.NOUN, "room"));
        dictionary.addWord("pokoj", new EnglishWord(PartOfSpeech.NOUN, "peace"));
        //when
        List<EnglishWord> result = dictionary.findEnglishWords("gra");
        List<EnglishWord> result2 = dictionary.findEnglishWords("pokoj");
        //then
        ...
        List<EnglishWord> expectedList2 = new ArrayList<>();
        expectedList2.add(new EnglishWord(PartOfSpeech.NOUN, "room"));
        expectedList2.add(new EnglishWord(PartOfSpeech.NOUN, "peace"));
